...
# commenting this out because I'd like to continue with the image I'm using
...
# commenting this out because there is some issue with this bit: https://github.com/gbrindisi/dockerfile-security/issues/6
# deny[msg] {
#    command := "user"
