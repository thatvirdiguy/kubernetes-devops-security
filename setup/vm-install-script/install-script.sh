...
sudo apt update
wget -P /tmp/ http://ftp.kr.debian.org/debian/pool/main/i/init-system-helpers/init-system-helpers_1.60_all.deb
sudo apt install /tmp/init-system-helpers_1.60_all.deb
